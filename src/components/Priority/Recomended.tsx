...
const Recomended = () => {
  return (
    <section className="grid grid-cols-2 h-[30rem] xl:h-[35rem] grid-rows-[1.5fr,_1fr] w-full gap-2 xl:grid-cols-2 xl:grid-rows-[17.5rem,_17.5rem] xl:gap-6">
      <Card
        img="/media/images/intl-img-hp-recore-prof-email-large-portrait.webp"
        desktopImg="/media/images/intl-img-hp-recore-prof-email-large-landscape.webp"
        hoverShadow={true}
      ...
      <Card
        ...
        desktopImg="/media/images/intl-img-hp-recore-wsb-small.webp"
        hoverShadow={true}
      ...
      <Card
        background="blue-cake"
        hoverShadow={true}
        desktopImg="/media/images/intl-img-hp-recore-web-hosting-small.webp"

...
const Security = () => {
  return (
    <section className="grid grid-cols-1 h-[30rem] xl:h-[35rem] grid-rows-[1fr,_1fr] w-full gap-y-2 xl:grid-cols-2 xl:grid-rows-[35rem] xl:gap-x-6">
      <Card
        img="/media/images/intl-img-hp-recore-wp-large-portrait.webp"
        desktopImg="/media/images/intl-img-hp-recore-wp-large-landscape.webp"
        hoverShadow={true}
      ...
      <Card
        img="/media/images/img-bl-hp-recore-ssl-large-portrait.webp"
        desktopImg="/media/images/img-bl-hp-recore-ssl-large-landscape.webp"
        hoverShadow={true}

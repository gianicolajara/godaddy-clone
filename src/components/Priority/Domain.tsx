...
const Domain = () => {
  return (
    <section className="grid grid-cols-1 h-[30rem] xl:h-[35rem] grid-rows-2 w-full gap-y-2 xl:grid-cols-2 xl:grid-rows-[35rem] xl:gap-x-6">
      <Card
        img="/godaddy-clone/media/images/intl-img-hp-recore-domains-large-portrait.webp"
        desktopImg="/godaddy-clone/media/images/intl-img-hp-recore-domains-large-landscape.webp"
      ...
      <Card
        img="/godaddy-clone/media/images/img-hp-recore-co-large-portrait.webp"
        desktopImg="/godaddy-clone/media/images/img-hp-recore-co-large-landscape.webp"
        hoverShadow={true}
